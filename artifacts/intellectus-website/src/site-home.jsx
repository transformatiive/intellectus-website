  ...
  return (
    <div className="itx-page">
      <div className="scroll">
        ...
        <div className="rsp-hero" style={{ borderBottom: "1px solid var(--line)" }}>
          <div className="rsp-hero-left">
            ...
            <h1 className="hero-up rsp-hero-h1" style={{ fontFamily: "var(--display)", fontSize: 84, lineHeight: 0.98, letterSpacing: "-0.02em", margin: 0, fontWeight: 600, textWrap: "balance", animationDelay: "0.22s" }}>
            ...
            <div className="hero-up" style={{ display: "flex", gap: 12, marginTop: 32, animationDelay: "0.48s", flexWrap: "wrap" }}>
              <button className="itx-btn itx-btn-primary" onClick={() => onNav?.("catalog")}>Ver catálogo<Icon name="arrow" size={14}/></button>
              <button className="itx-btn itx-btn-secondary" onClick={() => onNav?.("contact")}>Falar connosco</button>
            </div>
          </div>
          <div className="itx-img rsp-img-hero hero-fade" style={{ backgroundImage: `url(${HERO_IMG})`, minHeight: 540, animationDelay: "0.2s" }}/>
        </div>

        {/* Featured courses — scroll reveal */}
        <div ref={featuredRef} className="rsp-section">
        ...
        <div ref={statsRef} className="rsp-stats">
        ...
        <div ref={areasRef} className="rsp-section">
      ...
      <div className="scroll">
        ...
        <div style={{ padding: "80px 40px 60px", position: "relative", overflow: "hidden", color: "white", borderBottom: "1px solid var(--line)" }}>
          ...
          <div style={{ textAlign: "center", maxWidth: 760, margin: "0 auto", position: "relative" }}>
            <h1 className="hero-up rsp-hero-b-h1" style={{ fontFamily: "var(--display)", fontSize: 56, lineHeight: 1.05, margin: 0, fontWeight: 700, letterSpacing: "-.03em", color: "white", animationDelay: "0.1s" }}>
            ...
            <div className="hero-up" style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 24, padding: 8, background: "white", borderRadius: 14, border: "1px solid var(--line-2)", boxShadow: "var(--sh-2)", animationDelay: "0.38s" }}>
              <Icon name="search" size={18} color="var(--ink-3)" />
              <input className="itx-input" style={{ border: "none", padding: "6px 0", flex: 1, minWidth: 140 }} placeholder="Excel, Inglês, Marketing Digital…" defaultValue="" />
              <select className="itx-select" style={{ border: "none", width: 140, minWidth: 120 }}><option>Todas as áreas</option>{AREAS.map(a => <option key={a}>{a}</option>)}</select>
        ...
        {/* Courses grid */}
        <div ref={coursesRef} className="rsp-section-sm">
        ...
        {/* CTA empresas */}
        <div ref={ctaRef} className={`rsp-cta reveal ${ctaVisible ? "visible" : ""}`}>
          <div>
      ...
      <div className="scroll">
        ...
        <div className="rsp-hero-2col">
          <div className="rsp-hero-left">
            ...
            <h1 className="hero-up rsp-hero-c-h1" style={{ fontFamily: "var(--display)", fontSize: 64, lineHeight: 1, margin: 0, fontWeight: 700, letterSpacing: "-.03em", textWrap: "balance", animationDelay: "0.22s" }}>
            ...
            <div className="hero-up" style={{ display: "flex", gap: 10, marginTop: 28, animationDelay: "0.48s", flexWrap: "wrap" }}>
          ...
          <div className="itx-img rsp-img-hero hero-fade" style={{ backgroundImage: `url(${HERO_IMG})`, minHeight: 520, animationDelay: "0.2s" }}/>
        </div>

        {/* Testimonial */}
        <div ref={testimonialRef} className="rsp-stats">
